...
import {
    ...
    MAX_RECOMMENDATION_MESSAGE_LENGTH,
} from "../types/movieDetail.types";
import {
    searchUsers,
    loadAllUsers,
...
/**
 * Modal component for sending movie recommendations to other users
 */
export const RecommendModal: React.FC<RecommendModalProps> = ({
    ...
    useEffect(() => {
        if (visible) {
            setState(INITIAL_RECOMMENDATION_STATE);
            handleLoadAllUsers();
        }
    }, [visible]);
        ...
        >
            ...
            >
                ...
                <TextInput
                    ...
                    maxLength={MAX_RECOMMENDATION_MESSAGE_LENGTH}
                    multiline
                    numberOfLines={3}
                />
                <Text style={styles.charCount}>
                    {message.length}/{MAX_RECOMMENDATION_MESSAGE_LENGTH}
                </Text>
